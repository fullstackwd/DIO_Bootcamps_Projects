...
public class BeerControllerTest {
    ...
    @Test //chama de Post com sucesso, criação cerveja com sucesso
    void whenPOSTIsCalledThenABeerIsCreated() throws Exception {
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();

        // when
        when(beerService.createBeer(beerDTO)).thenReturn(beerDTO); //chamada Mochito.when
    ...
    @Test
    void whenPOSTIsCalledWithoutRequiredFieldThenAnErrorIsReturned() throws Exception { //retorna um erro
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test //quando não é encontrar no nosso sistema
